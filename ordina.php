...
<head>
    ...
    <title>Ordina a casa | PolloTribe</title>
...
<body>
    ...
    <section class="order-section">
        <div class="order-content">
            <h1>PolloTribe direttamente a casa tua!</h1>
            <div class="delivery-text">
                <p>Ordina con PolloTribe e gusta le nostre specialità comodamente a casa, perfetto per ogni occasione.</p>
                <p>Bastano pochi click!</p>
            </div>
            <a href="https://glovo.it/..." class="btn-delivery" target="_blank">ORDINA ORA</a>
        </div>
    </section>
